...
using Dapper;
using HinaConfigCenter.Core.Dapper;
...
namespace HISInterfaceService.Dapper
{
    public class DapperRepository : IDapperRepository
    {
        ...
        {
            connStr = ConfigurationManager.ConnectionStrings["OrderSyncConn"].ConnectionString;// @"Server=192.168.2.27\sql;Database=OrderSync;User Id =sa; Password=password";
        }
        ...
        where TEntity : IEntity<T>
    {
        ...
        public  bool ExecuteWithTransaction(Action<SqlConnection, IDbTransaction> act)
        {
            bool flag = true;
            try
            {
